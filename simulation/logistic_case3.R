...
beta_result2 <- logistic_regression_grad(X_list, y_list, graph, beta_true = true_beta,lr=0.1,
                                         epochs = 5e4, rate = 0.5, neighb_num = 5)
...
saveRDS(data_list, "logistic_case3.rds")
